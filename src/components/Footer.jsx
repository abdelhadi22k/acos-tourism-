    ...
    <footer className="Footer">
        ...
        <Row className="footer">
          <Col md={2}>
            ...
            <ul>
              ...
              <li>
                <React.Fragment>
                  <p onClick={handleClickOpen2}>About us</p>
                  <BootstrapDialog
              ...
              <li>
                <React.Fragment>
                  <p onClick={handleClickOpen3}> FQAs</p>
                  <BootstrapDialog
                  ...
                  >
                    ...
                    <DialogContent dividers>
                      <Typography gutterBottom>
                        ...
                        Acos store specializes in selling personal computer (PC)
                        parts and assemblies only. We offer a variety of
                        computer parts such as processors, graphics cards,
                        motherboards, and RAM, as well as custom assemblies.
                      </Typography>

                      <Typography gutterBottom>
                        <h5>Are all the products available original?</h5>
                        Yes, all the products we sell are original and
                        guaranteed from the best international brands.
                      </Typography>

                      <Typography gutterBottom>
                        <h5>
                          Can I customize a computer assembly to my needs?
                        </h5>
                        naturally! We offer a custom computer assembly service
                        based on your specific requirements and needs, whether
                        you need it for gaming, design, or office work.
                      </Typography>

                      <Typography gutterBottom>
                        <h5>Do you provide shipping service within Algeria?</h5>
                        Yes, we provide shipping service to all states of
                        Algeria, ensuring that the products arrive in their best
                        condition.
                      </Typography>

                      <Typography gutterBottom>
                        <h5>How long does it take to process my order?</h5>
                        Order processing time varies depending on the
                        availability of the required parts and the type of
                        assembly. Typically, the assembly process takes 3 to 5
                        business days.
                      </Typography>
                      ...
                      <Typography gutterBottom>
                        ...
                        Yes, you can return or exchange the product within a
                        specified period provided that it is in its original
                        condition and unused. Terms and conditions apply.
                      </Typography>

                      <Typography gutterBottom>
                        <h5>How can I contact customer service?</h5>
                        You can contact us by phone, email, or through our
                        social media pages. We are here to help you with any
                        inquiries.
                      </Typography>

                      <Typography gutterBottom>
                        <h5>Do you offer offers and discounts?</h5>
                        Yes, we offer periodic offers and discounts on a range
                        of products. You can follow our website and social media
                        pages to stay updated with the latest offers.
                      </Typography>
                    </DialogContent>
                  </BootstrapDialog>
                </React.Fragment>
          ...
          <Col className="social_media_link_col" md={6}>
            ...
            <ul className="social_media_link">
              <li>
                ...
                <a
                  target="blank"
                  href="https://www.instagram.com/acos.ag/reels/?hl=ar"
                >
                  {" "}
      ...
      <Container>
        <Row className="footer_Policy">
          ...
          <Col md={2}>
            <React.Fragment>
              <p onClick={handleClickOpen1}>Privacy Policy</p>
              <BootstrapDialog
